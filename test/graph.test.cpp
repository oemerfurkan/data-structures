...
int main() {
    graph_impl::Graph *graph = new graph_impl::Graph();
    ...
    graph->add_edge(&graph->nodes[0], &graph->nodes[2], 1);
    graph->add_edge(&graph->nodes[0], &graph->nodes[3], 1);
    graph->add_edge(&graph->nodes[0], &graph->nodes[4], 1);
    graph->add_edge(&graph->nodes[1], &graph->nodes[2], 1);
    graph->add_edge(&graph->nodes[1], &graph->nodes[3], 1);
