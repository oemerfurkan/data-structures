...
using namespace directed_graph_impl;

const std::string font_path = "/System/Library/Fonts/Avenir.ttc";

DirectedGraph *DirectedGraph::create()
{
...
GraphNode *DirectedGraph::add_node()
{
...
GraphNode *DirectedGraph::delete_node(GraphNode *node)
{
...
GraphNode *DirectedGraph::add_edge(GraphNode *node1, GraphNode *node2, int weight)
{
    node1->neighbors.push_back(*node2);
    return node1;
}

GraphNode *DirectedGraph::delete_edge(GraphNode *node1, GraphNode *node2)
{
...
//TODO: Implement rendering of the directions of the edges
void DirectedGraph::render_graph()
{
    sf::ContextSettings settings;
    settings.antiAliasingLevel = 8;

    sf::RenderWindow window(sf::VideoMode({800, 600}), "Directed Graph", sf::Style::Default, sf::State::Windowed, settings);
